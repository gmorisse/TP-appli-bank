<%-- 
    Document   : ConseillerDecouvertClient
    Created on : 21 juin 2021, 16:53:20
    Author     : PC
--%>
    ...
    <body>
        ...
        <div>
            ...
            <div class="mt-4 container">
                ...
                <br><br>
                <div class="row">
                    <div class="col-sm-8 pb-5 center">
                        <div class="card my-font-family p-2 card-shadow ">
                            <div class="row">
                                <div class="col-sm-10">
                                    ...
                                    <br>
                                    <form>
                                        <p class="label-perso">Découvert : </p>
                                    </form>
                    ...
                    <button type="button" onclick="window.location.href = 'ConseillerGestionDecouverts'" class="btn btn-block btn-primary">Retour</button>
                </div>
            </div>
        </div>
    </body>
